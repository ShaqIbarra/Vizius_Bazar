                                    ...
                                    <div class="col-lg-7 col-md-10">
                                        <div class="banner_content text_white text-center">
                                            ...
                                            <p class="staggered-animation" data-animation="fadeInUp"
                                                ...
                                                elección </p>
                                            <a class="btn btn-white staggered-animation" href="<?php echo e(url('/products')); ?>"
                ...
                <div class="row shop_container">
                        ...
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="<?php echo e(url('product_detail/')); ?>">
                                    <img class="card-img-top" src="<?php echo e(asset('img/Product1.jpg')); ?>"
                                        style="width: 300px !important; height: 450px !important; border-radius: 5px;">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        
                                        <li><a href="<?php echo e(url('product_detail/')); ?>" class=""><i
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="<?php echo e(url('product_detail/')); ?>"></a>
                                </h6>
                                ...
                                <div class="add-to-cart">
                                    <a href="<?php echo e(url('add_to_cart/')); ?>" class="btn btn-fill-out btn-radius"><i
                    ...
                    <div class="col-lg-4 col-md-4 col-6">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="<?php echo e(url('product_detail/')); ?>">
                                    <img class="card-img-top" src="<?php echo e(asset('img/Product2.jpg')); ?>"
                                        style="width: 300px !important; height: 450px !important; border-radius: 5px;">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                    ...
                    <div class="col-lg-4 col-md-4 col-6">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="<?php echo e(url('product_detail/')); ?>">
                                    <img class="card-img-top" src="<?php echo e(asset('img/Product3.jpg')); ?>"
                                        style="width: 300px !important; height: 450px !important; border-radius: 5px;">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
...
<?php echo $__env->make('web.partials.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Shaq\Vizius_Bazar\resources\views/web/index.blade.php ENDPATH**/ ?>